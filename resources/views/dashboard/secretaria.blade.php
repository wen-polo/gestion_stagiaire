...
<div class="flex flex-col md:flex-row min-h-screen">
    ...
    <main class="flex-1 bg-gray-100 p-6">
        <div class="container mx-auto">
            <h1 class="text-2xl font-bold mb-6">Tableau de Bord - Secretaria</h1>
                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            ...
                            <td class="border px-4 py-2">
                                <button onclick="openModalSecretaria({{ $demande->id }})" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                                    Voir Détail
                                </button>
                            </td>
                        </tr>
...
<script>
    function openModalSecretaria(id) {
        fetch(`/secretaria/demande/${id}`)
