                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            ...
                            <td class="border px-4 py-2">
                                <button onclick="openModalDsi({{ $demande->id }})" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
                                    Voir Détail
                                </button>
                            </td>
                        </tr>
...
<script>
    function openModalDsi(id) {
        // Récupérer les données spécifiques au DSI via une requête AJAX
        fetch(`/dsi/demande/${id}`)
